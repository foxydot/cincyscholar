...
class MSDLAB_Report_Output{
    ...
    function student_form($student_data){
        ...
        foreach($student_data['scholarship'] AS $scholarship) {
            ...
            if($scholarship_cnt == 1) {
                $ret['ApplicantScholarship_GPA1_' . $s] = $this->form->field_textfield('ApplicantScholarship_GPA1_' . $s, $scholarship->GPA1 ? $scholarship->GPA1 : 0, 'GPA 1', '0.00', array('type' => 'number', 'min' => 0.000, 'max' => 100.000, 'step' => 0.001, 'minlength' => 1), array('col-md-2', 'col-sm-12', 'gpa1in'));
                $ret['ApplicantScholarship_GPA2_' . $s] = $this->form->field_textfield('ApplicantScholarship_GPA2_' . $s, $scholarship->GPA2 ? $scholarship->GPA2 : 0, 'GPA 2', '0.00', array('type' => 'number', 'min' => 0.000, 'max' => 100.000, 'step' => 0.001, 'minlength' => 1), array('col-md-2', 'col-sm-12', 'gpa2in'));
                $ret['ApplicantScholarship_GPA3_' . $s] = $this->form->field_textfield('ApplicantScholarship_GPA3_' . $s, $scholarship->GPA3 ? $scholarship->GPA3 : 0, 'GPA 3', '0.00', array('type' => 'number', 'min' => 0.000, 'max' => 100.000, 'step' => 0.001, 'minlength' => 1), array('col-md-2', 'col-sm-12', 'gpa3in'));
                $ret['ApplicantScholarship_GPAC_' . $s] = $this->form->field_textfield('ApplicantScholarship_GPAC_' . $s, $scholarship->GPAC ? $scholarship->GPAC : 0, 'GPA Cumulative', '0.00', array('type' => 'number', 'min' => 0.000, 'max' => 100.000, 'step' => 0.001, 'minlength' => 1), array('col-md-2', 'col-sm-12', 'gpacin'));
            } else {
                $ret['ApplicantScholarship_GPA1_' . $s] = $this->form->field_hidden('ApplicantScholarship_GPA1_' . $s, $scholarship->GPA1 ? $scholarship->GPA1 : 0, 'GPA 1', '0.000', array('col-md-2', 'col-sm-12', 'gpa1'));
                $ret['ApplicantScholarship_GPA2_' . $s] = $this->form->field_hidden('ApplicantScholarship_GPA2_' . $s, $scholarship->GPA2 ? $scholarship->GPA2 : 0, 'GPA 2', '0.000', array('col-md-2', 'col-sm-12', 'gpa2'));
                $ret['ApplicantScholarship_GPA3_' . $s] = $this->form->field_hidden('ApplicantScholarship_GPA3_' . $s, $scholarship->GPA3 ? $scholarship->GPA3 : 0, 'GPA 3', '0.000', array('col-md-2', 'col-sm-12', 'gpa3'));
    ...
    function application_form($student_data){
        ...
        $ret['Applicant_HighSchoolGPA'] = $this->form->field_textfield('Applicant_HighSchoolGPA', $student_data['personal']->HighSchoolGPA ? $student_data['personal']->HighSchoolGPA : null, 'High School GPA', '0.000', array('required' => 'required', 'type' => 'number', 'min' => 0.000, 'max' => 100.000, 'step'=> 0.001, 'minlength' => 1), array('required', 'col-md-3', 'col-sm-12'));
