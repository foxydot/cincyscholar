...
if (!class_exists('MSDLab_CSF_Management')) {
    class MSDLab_CSF_Management {
        ...
        var $counties_array = array( //TODO fix to use same abbreviations as above for JS integration.
            "Alabama" => array(
                "Autauga County",
                "Baldwin County",
                "Barbour County",
        ...
        function get_form($form_id,$options = array()){
            ...
            switch($form_id){
                case 'application':
                    //TODO: Build dependancy options for javascript
        ...
        if($(this).find('input[type=checkbox]').is(':checked')){
            ...
            toggled.slideUp(0);
                    ...
                    $ret['cboYearEnter'] = $this->form->field_select("cboYearEnter",'2',"Please check which year you will enter this fall",$edu_lvls,array('req'));
                    $ret['rdoGraduate'] = $this->form->field_boolean("rdoGraduate",false,"Do you have a degree?",array('req'));
                    $ret['txtGradLevel'] = $this->form->field_textfield('txtGradLevel',null,'If so, what level?',array('switchable'));
                    $ret['rdoCSF'] = $this->form->field_boolean('rdoCSF', true, 'Have you ever applied to the Cincinnati Scholarship Foundation before?',array('req'));
                    $ret['txtCSFwhen'] = $this->form->field_date('txtCSFwhen', null, 'if so, when (approx.)?',array('switchable'));
                    $ret['txtFirstName'] = $this->form->field_textfield('txtFirstName',null,'First Name',array('req'));
                    $ret['txtMI'] = $this->form->field_textfield('txtMI',null,'Middle Initial');
                    $ret['txtLastName'] = $this->form->field_textfield('txtLastName',null,'Last Name',array('req'));
                    $ret['txtSSN1'] = $this->form->field_textfield('txtSSN1',null,'Last 4 numbers of your SS#',array('req'));
                    $ret['txtCity'] = $this->form->field_textfield('txtCity',null,'City',array('req'));
                    $ret['cboState'] = $this->form->field_select('cboState','OH','State',$this->states_array,array('req'));
                    $ret['cboCounty'] = $this->form->field_select('cboCounty',null,'County',$this->counties_array);
                    $ret['txtZip'] = $this->form->field_textfield('txtZip',null,'ZIP Code', array('req'));
